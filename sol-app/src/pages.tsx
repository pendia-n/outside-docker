...
export const LandingPage = () => (
  <main data-page="landing">
    ...
    <section id="how" class="section">
      <div class="section-intro"><p class="eyebrow">ONE RECORD. THREE LAYERS.</p><h2>Integrity you can explain<br />to anyone.</h2><p>OD separates content equality, sequence integrity, and independent anchoring so every result can show exactly what passed or failed.</p></div>
    ...
    <section id="access" class="access-section">
      <div><p class="eyebrow light">READY WHEN YOU ARE</p><h2>Start with a private<br />integrity record.</h2><p>Development accounts activate immediately. Production supplier subscriptions and 30-day verifier passes activate only after a verified Stripe webhook.</p></div>
